  ...
  return (
    <Container mt={20}>
      <Box display={{ md: 'flex' }}  >
        ...
        <Box m={8} mb={-5} w="100px" h="100px" borderColor="whiteAlpha.400" borderWidth={3} borderStyle="solid" borderRadius={'full'} display="flex-end" >
          <Image borderRadius={'full'} w="100%" h="100%" src="/images/ananya.jpg" alt="Profile Image" />
      </Box>
      </Box>
          
      <motion.div initial={{y: 30}} animate={{y: 40}} transition={{delay: 0.7, duration: 1}} >
      <Box>
